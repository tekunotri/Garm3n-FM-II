...
If the crosshair aren't centralized do the following:
...
(If the crosshairs aren't centralized then you sometimes have to change wide and tall too, not just xpos and ypos
